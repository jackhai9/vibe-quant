...
<!-- Output: docs 目录架构概述与文件清单（含配置、自动发现持仓、操作者安全、小额主网验证、回归证据、发布门禁与候选发布清单说明） -->
<!-- Pos: docs 文件夹级说明 -->
<!-- 一旦我所属的文件夹有所变化，请更新我。 -->
...
回归证据用于把高风险运行路径映射到具体自动化测试与剩余 live-system 边界。<br>
...
- `regression-evidence.md`：reconnect、stale、执行恢复、panic close 与保护止损回归证据
