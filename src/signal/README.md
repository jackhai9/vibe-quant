...
`orderbook_pressure` 基于 bookTicker 顶档量 + depth10 档位，生成带 `price/ttl/cooldown/base_mult/jitter` 覆盖的信号，并附带基准片大小 anti-repeat、可选公共 ROI/accel modifiers 与 active burst pacing 元数据。<br>
